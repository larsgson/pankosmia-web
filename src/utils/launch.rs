    ...
    rocket_instance
        .mount(
            ...
            routes![
                ...
                crate::auth::oauth_flow::auth_github_callback,
                crate::auth::oauth_flow::auth_logout,
                crate::auth::oauth_flow::me,
                // G2: GitHub webhooks.
                crate::catalog::webhook::catalog_webhook,
                crate::catalog::webhook::language_webhook,
            ],
        )
        ...
        .mount(
            ...
            routes![
                ...
                endpoints::git2::new_translation_plan_resource::new_translation_plan_resource_repo
        ...
        .mount(
            ...
            routes![
                ...
                endpoints::burrito2::raw_text_ingredient::watch_text_ingredient,
...
pub(crate) fn add_app_settings(
    ...
    rocket_instance.manage(AppSettings {
        ...
        client_config,
        default_language: crate::identity::LanguageCode::parse(
            user_settings_json["default_language"]
                .as_str()
                .unwrap_or("en"),
        )
        .unwrap_or_else(|_| crate::identity::LanguageCode::parse("en").unwrap()),
    })
}
